...
RUN apt-get update
RUN apt-get install -qy mysql-server mysql-client apache2 php5 php5-dev php5-gd php5-mysql subversion vim nano less mc sudo unoconv imagemagick ghostscript libgs-dev antiword xpdf libav-tools ffmpeg libimage-exiftool-perl cron wget poppler-utils zip python3-uno libreoffice-writer libreoffice-draw libreoffice-calc libreoffice-impress libreoffice-base-core libreoffice-core libreoffice-pdfimport libreoffice-avmedia-backend-gstreamer libreoffice-math
